...
public class DialogueElement extends AppCompatDialogFragment {
        ...
        builder.setView(view)
                ...
                .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        listener.applyTexts(Name_new_element,Quantity_new_element);
                    }
                });
...
//context = "activity"
    ...
    public interface DialogueElementListener{
        void  applyTexts(String Name_new_element, String Quantity_new_element );
    }
